...
export default function ContactsCTA({}: Props) {
  ...
  return (
    <section className="relative z-0 w-full animate-gradient bg-teal-500 px-12 py-12 dark:bg-gray-900 lg:px-16 lg:py-24">
      <div className="mx-auto flex h-full max-w-md flex-col items-center justify-center gap-y-3">
        <h2 className="w-full text-center font-lexend text-3xl font-bold tracking-tighter text-primary dark:text-tertiary lg:text-4xl">
          {header}
        </h2>
