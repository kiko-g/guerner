...
export default function LanguageSwitch({}: Props) {
  ...
  return (
    <div className="relative z-10">
      ...
      {open ? (
        <ul className="absolute mt-2 w-full overflow-auto rounded bg-gray-50 py-1.5 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {active ? (
                    <CheckIcon
                      className="mt-0 h-4 w-4 text-primary group-hover:text-white dark:text-tertiary md:h-[1.1rem] md:w-[1.1rem]"
                      aria-hidden="true"
                    />
                  ) : null}
                </Link>
